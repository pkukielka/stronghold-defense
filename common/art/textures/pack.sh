...
rename -f 's/-/_/g' ./out/*-*.png
java -classpath "../../lib/gdx.jar:../../lib/gdx-tools.jar" com.badlogic.gdx.tools.imagepacker.TexturePacker2 ./out ../../src/main/resources/data/textures/effects spells
...
rename -f 's/-/_/g' ./out/*-*.png
java -classpath "../../lib/gdx.jar:../../lib/gdx-tools.jar" com.badlogic.gdx.tools.imagepacker.TexturePacker2 ./out ../../src/main/resources/data/textures/effects misc
